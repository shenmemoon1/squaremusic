			...
			var html = `
				<div id="audio-wrapper">
					<div class="audio-view-wrapper">
						...
						<p class="audio-playspeed" οnclick="listenPlaySpeed('show')">倍速</p>
					</div>
					...
					<div class="audio-model">
						<div class="audio-model-wrapper">
							<div class="radio-wrapper">
								...
								<label for='play-speed1' οnclick="listenPlaySpeed(0.5)">0.5 X</label>
							</div>
							<div class="radio-wrapper">
								<input type='radio' id='play-speed2' name='play-speed'>
								<label for='play-speed2' οnclick="listenPlaySpeed(0.75)">0.75 X</label>
							</div>
							<div class="radio-wrapper">
								<input type='radio' id='play-speed3' checked name='play-speed'>
								<label for='play-speed3' οnclick="listenPlaySpeed(1)">1.0 X</label>
							</div>
							<div class="radio-wrapper">
								<input type='radio' id='play-speed4' name='play-speed'>
								<label for='play-speed4' οnclick="listenPlaySpeed(1.25)">1.25 X</label>
							</div>
							<div class="radio-wrapper">
								<input type='radio' id='play-speed5' name='play-speed'>
								<label for='play-speed5' οnclick="listenPlaySpeed(1.5)">1.5 X</label>
							</div>
							<div class="radio-wrapper">
								<input type='radio' id='play-speed6' name='play-speed'>
								<label for='play-speed6' οnclick="listenPlaySpeed(1.75)">1.75 X</label>
							</div>
							<div class="radio-wrapper">
								<input type='radio' id='play-speed7' name='play-speed'>
								<label for='play-speed7' οnclick="listenPlaySpeed(2)">2 X</label>
							</div>
							<button οnclick="listenPlaySpeed('hide')">取消</button>
						</div>
					</div>
				</div>
			`;
...
// ————————————————
// 版权声明：本文为CSDN博主「ganganlee」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
// 原文链接：https://blog.csdn.net/weixin_44540711/article/details/105165119